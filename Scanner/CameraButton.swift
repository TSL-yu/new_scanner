...
class CameraButton: UIButton {
    ...
    override var isSelected: Bool {
        didSet {
            ...
            morph.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeOut)
    ...
    @objc func touchUpInside(sender: UIButton) {
        ...
        colorChange.timingFunction = CAMediaTimingFunction(name: CAMediaTimingFunctionName.easeOut)
    ...
    @objc func touchDown(sender: UIButton) {
        ...
        morph.toValue = UIColor(displayP3Red: 1, green: 0, blue: 0, alpha: 0.5)
